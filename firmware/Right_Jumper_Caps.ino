//Right (goes forward with the controlled wheel speed in the front of the car) for 2 seconds
...
void setup() {
  ...
  // Front motors speed (0–255)
  analogWrite(ENA_rear, 255); // Front Left Motor
  analogWrite(ENB_rear, 150); // Front Right Motor

  // Rear motors direction (full speed always with jumpers)
